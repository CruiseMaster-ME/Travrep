...
angular.module("ui-notification").run(["$templateCache", function($templateCache) {$templateCache.put("angular-ui-notification.html","<div class=\"ui-notification\"><h5 ng-show=\"title\" ng-bind-html=\"title\"></h5><div class=\"message\" ng-bind-html=\"message\"></div></div>");}]);